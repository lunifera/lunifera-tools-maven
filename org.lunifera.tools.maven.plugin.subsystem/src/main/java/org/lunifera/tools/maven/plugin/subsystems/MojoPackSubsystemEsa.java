...
public class MojoPackSubsystemEsa extends AbstractMojo {
     ...
     */
    @Parameter(property = "embedContents", defaultValue = "false")
    ...
    public File createArchive() throws MojoExecutionException {
        ...
        if (!outputDirectory.exists()) {
            ...
            if (embedContents == true) {
                ...
                File dependenciesDirectoryFile = new File(buildDirectory,
                        dependenciesDirectory + "/");
                if (!dependenciesDirectoryFile.exists()) {
                    dependenciesDirectoryFile.mkdirs();
                }
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (skipIfEmpty || !getOutputDirectory().exists()) {
            ...
            synchronized (MojoPackSubsystemEsa.class) {
