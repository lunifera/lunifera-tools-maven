package org.lunifera.tools.maven.plugin.subsystems.utils;
        ...
        if ( ( artifact.getFile() != null ) && artifact.getFile().isFile() )
        {
            ...
            try
            {
                ...
                if ( jar.getManifest() != null )
                {
                    ...
                    Map<String,?> bundleSymbolicNameHeader = analyzer.parseHeader( symbolicNameAttribute );
            ...
            {
                throw new IllegalStateException( "Error reading manifest in jar "
